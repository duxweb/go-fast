...
require (
	...
	github.com/duxweb/go-fast/v2 v2.0.0
...
require (
	...
	github.com/duxweb/go-lock v0.0.0-20250503115712-1f7fbbb06b17 // indirect
	github.com/duxweb/go-queue v0.0.0-20250503121409-e9ec2092fd53 // indirect
...
replace github.com/duxweb/go-fast/v2 => ../
